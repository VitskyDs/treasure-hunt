  ...
  return (
    <Main>
      <div>
        ...
        <p>
          Among these stones lie the voices that shaped Tel Aviv and the Yishuv:
          the poet Bialik, the dreamer Tchernichovsky, the mayor Dizengoff. And
          here too rests Dr. Haim Arlosoroff.
        </p>
        <p>
